...
<body>
    ...
    <div class="container">
        <form action="/edit_event/{{ $event->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Alamat</label>
                <input type="text" class="form-control" name="alamat" value="{{ $event->alamat }}">
            </div>
            <div class="form-group">
                <label>Deskripsi</label>
                <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control">{{ $event->deskripsi }}</textarea>
            </div>
            <div class="form-group">
                <label>Tanggal</label>
