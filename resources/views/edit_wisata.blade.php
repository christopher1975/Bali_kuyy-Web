...
<body>
    ...
    <div class="container">
        <form action="/edit_wisata/{{ $wisata->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="" cols="30" rows="10" class="form-control" name="deskripsi" id="deskripsi">{{ $wisata->deskripsi }}</textarea>
            </div>
