...
<body>
    <div class="sidebar-wrapper">
        <div class="list-group">
            ...
            <a href="/tambah_wisata" class="list-group-item list-group-item-action active">
    ...
    <div class="container">
        <form action="/tambah_wisata" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="" cols="30" rows="10" class="form-control" name="deskripsi" id="deskripsi"></textarea>
            </div>
