...
<body>
    <div class="sidebar-wrapper">
        <div class="list-group">
            ...
            <a href="/daftar_feedback" class="list-group-item list-group-item-action active">
    ...
    <div class="container">
        <h1 class="text-center mt-4 mb-4">Daftar Feedback</h1>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($feedbacks as $feedback)
                    <tr>
                        <td>{{ $feedback->user->nama }}</td>
                        <td>{{ $feedback->wisata->nama_wisata }}</td>
                        <td>{{ $feedback->feedback }}</td>
                        <td>{{ $feedback->bintang }}/5</td>
                        <td class="d-flex">
                            <form action="/hapus_feedback" method="post">
                                @csrf
