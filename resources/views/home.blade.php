...
<head>
    ...
    <style>
        * {
        ...
        .wrapper {
            background: url("https://source.unsplash.com/bnMPFPuSCI0/1920x1536");
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <p class="text-center">
                BALI KUY merupakan aplikasi web dan mobile yang dikembangkan untuk mempermudah user dalam mencari tempat
                destinasi serta event-event menarik dan terfavorit yang ada di bali. Sistem ini dapat mempermudah untuk
                turis mancanegara maupun warga lokal yang ingin berpergian ke bali serta lebih mengenal apa saja
                kebudayaan yang ada di bali.
                Aplikasi ini menangani antara lain: rekomendasi destinasi serta event-event menarik yang yang ada di
                bali, dapat juga memberikan informasi tentang harga tiket,hari perayaan ,destinasi parade pada destinasi
                yang dituju, informasi seputar event kebudayaan adat istiadat yang ada di bali.
